...
const SEARCH_ALIASES = {
  ...
  'district':    ['district court', 'sessions court', 'magistrate court', 'district consumer forum', 'consumer commission'],
  'subdistrict': ['tehsil court', 'revenue court', 'taluk court'],
  'state':       ['state consumer commission'],
  'high_court':  ['high court', 'HC', 'appellate court'],
  'NGT':         ['national green tribunal', 'environment tribunal'],
  'NCLT':        ['national company law tribunal', 'insolvency', 'IBC'],
