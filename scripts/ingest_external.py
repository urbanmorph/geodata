...
DATASETS: list[Dataset] = [
    ...
    Dataset(
        id='wards_chennai',
        name='Chennai (GCC) Wards (2022)',
        src=str(HOME / 'GitHub/notf/supporting documents/chennai/chennai-wards.kml'),
        category='administrative',
        level='wards_chennai',
        description='Greater Chennai Corporation — 200 ward boundaries across the 15 zones. 2022 delimitation.',
    ...
    Dataset(
        id='wards_hyderabad',
        name='Hyderabad (GHMC) Wards (2022)',
        src=str(HOME / 'GitHub/notf/supporting documents/hyderabad/hyderabad-wards.kml'),
        category='administrative',
        level='wards_hyderabad',
        description='Greater Hyderabad Municipal Corporation — 145 wards across 6 zones. 2022 delimitation.',
    ...
    Dataset(
        ...
        source_url='https://data.opencity.in/dataset/mumbai-wards-map',
        license='ODbL-1.0',
        unit='wards',
    ...
    Dataset(
        id='wards_kolkata',
        name='Kolkata (KMC) Wards (2022)',
        src=str(HOME / 'GitHub/notf/supporting documents/kolkata/kolkata-wards.kml'),
        category='administrative',
        level='wards_kolkata',
        description='Kolkata Municipal Corporation — 141 ward boundaries across the 16 boroughs. 2022 delimitation.',
        source_org='Kolkata Municipal Corporation',
        source_url='https://data.opencity.in/dataset/kolkata-wards-information',
        license='ODbL-1.0',
        unit='wards',
    ...
    Dataset(
        id='wards_pune',
        name='Pune (PMC) Wards (2022)',
        src=str(HOME / 'GitHub/notf/supporting documents/pune/pune-wards.kml'),
        category='administrative',
        level='wards_pune',
        description='Pune Municipal Corporation — 58 administrative wards. 2022 delimitation.',
        source_org='Pune Municipal Corporation',
        source_url='https://data.opencity.in/dataset/pune-wards-info',
        license='ODbL-1.0',
        unit='wards',
    ...
    Dataset(
        id='wards_ahmedabad',
        name='Ahmedabad (AMC) Wards (2024)',
        src=str(HOME / 'GitHub/notf/supporting documents/ahmedabad/ahmedabad-wards.kml'),
        category='administrative',
        level='wards_ahmedabad',
        description='Ahmedabad Municipal Corporation — 48 wards across the 7 zones. 2024 delimitation.',
        source_org='Ahmedabad Municipal Corporation',
        source_url='https://data.opencity.in/dataset/amdavad-municipal-corporation-wards-map-2024',
        license='ODbL-1.0',
        unit='wards',
    ...
    Dataset(
        id='wards_jaipur',
        name='Jaipur (JNN) Wards (2024)',
        src=str(HOME / 'GitHub/notf/supporting documents/jaipur/jaipur-wards.kml'),
        category='administrative',
        level='wards_jaipur',
        description='Greater Jaipur Nagar Nigam — 150 ward boundaries. 2024 delimitation.',
        source_org='Greater Jaipur Nagar Nigam',
        source_url='https://data.opencity.in/dataset/jaipur-municipal-corporation-wards-map',
        license='ODbL-1.0',
        unit='wards',
    ...
    Dataset(
        id='wards_gurugram',
        name='Gurugram (MCG) Wards (2024)',
        src=str(HOME / 'GitHub/notf/supporting documents/gurugram/gurugram-wards.kml'),
        category='administrative',
        level='wards_gurugram',
        description='Municipal Corporation of Gurugram — 35 ward boundaries. 2024 delimitation.',
        source_org='Municipal Corporation of Gurugram',
        source_url='https://data.opencity.in/dataset/gurugram-wards-map',
        license='ODbL-1.0',
        unit='wards',
    ...
    Dataset(
        id='wards_kochi',
        name='Kochi (KMC) Wards (2024)',
        src=str(HOME / 'GitHub/notf/supporting documents/kochi/kochi-wards.kml'),
        category='administrative',
        level='wards_kochi',
        description='Kochi Municipal Corporation — 74 ward boundaries. 2024 delimitation.',
        source_org='Kochi Municipal Corporation',
        source_url='https://data.opencity.in/dataset/kochi-wards-map',
        license='ODbL-1.0',
        unit='wards',
    ...
    Dataset(
        ...
        description='Bhubaneshwar Municipal Corporation — 67 ward boundaries.',
        source_org='Bhubaneshwar Municipal Corporation',
        source_url='https://data.opencity.in/dataset/bhubaneswar-administrative-boundaries',
        license='ODbL-1.0',
        unit='wards',
    ...
    Dataset(
        id='wards_vizag',
        name='Visakhapatnam (GVMC) Wards (2024)',
        src=str(HOME / 'GitHub/notf/supporting documents/vishakapatnam/vizag-wards.kml'),
        category='administrative',
        level='wards_vizag',
        description='Greater Visakhapatnam Municipal Corporation — 98 wards. 2024 delimitation.',
        source_org='Greater Visakhapatnam Municipal Corporation',
        source_url='https://data.opencity.in/dataset/visakhapatnam-wards-map-2024',
        license='ODbL-1.0',
        unit='wards',
    ...
    Dataset(
        id='wards_thane',
        name='Thane (TMC) Wards (2023)',
        src=str(HOME / 'GitHub/notf/supporting documents/thane/thane-wards.kml'),
        category='administrative',
        level='wards_thane',
        description='Thane Municipal Corporation — 47 electoral wards. 2023 delimitation.',
        source_org='Thane Municipal Corporation',
        source_url='https://data.opencity.in/dataset/thane-wards-map',
        license='ODbL-1.0',
        unit='wards',
